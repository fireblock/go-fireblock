...
func TestReadECDSAKeys1(t *testing.T) {
	_, _, err := ReadECDSAKeys(jwkInvalid)
	if err != nil {
...
func TestECDSAFingerprint(t *testing.T) {
	pub, _, _ := ReadECDSAKeys(jwkPubKey1)
...
func TestECDSASign(t *testing.T) {
	...
	pub, _, _ := ReadECDSAKeys(jwkPubKey1) // bWVzc2FnZQ
...
func TestECDSAVerify(t *testing.T) {
	pub, priv, _ := ReadECDSAKeys(jwkPrivKey1)
